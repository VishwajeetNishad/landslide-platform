...
| [docs/FRONTEND_REVIEW.md](docs/FRONTEND_REVIEW.md) | Review of the 4 Sept frontend report against the live database — which figures are real and which must be corrected before the demo |
